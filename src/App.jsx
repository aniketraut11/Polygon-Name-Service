...
const tld = '.ninja';
const CONTRACT_ADDRESS = "0x7Fefc1a4c5AEfD86a7134c496697D478d26aBe04";
        ...
        <div className="header-container">
          	<header>
          		<div className="left">
          			...
          			<p className="subtitle">Your API on the blockchain to register domains!</p>
          		</div>
